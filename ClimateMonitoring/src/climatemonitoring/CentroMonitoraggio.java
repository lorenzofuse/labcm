...
public class CentroMonitoraggio {
     ...
     * @throws FileNotFoundException se il file CSV non viene trovato
     * @throws IOException           se si verifica un errore di I/O durante la lettura del file
     * @throws ArrayIndexOutOfBoundsException se il formato del file non è valido
    ...
    public static List<CentroMonitoraggio> createCentersList() {
        ...
        try {
            ...
            // File non trovato
            System.err.println("ERRORE : IL FILE NON E' STATO TROVATO");
        } catch (IOException e) {
